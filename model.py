...
class MultiHeadAttentionBlock(nn.Module):
    ...
    def forward(self, q, k, v, mask):
        ...
        query = query.view(query.shape[0], query.shape[1], self.h, self.d_k).transpose(1,2)  # (batch, h, seq, d_k)
...
class DecoderBlock(nn.Module):
    def __init__(self, 
        ...
        self.feef_forward_block = feed_forward_block
